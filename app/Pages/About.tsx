    ...
    return (
        ...
        >   
            <div className='flex w-full items-center space-x-20'>
                <h1 className={generalVar.className + ' text-heading-1 font-medium text-abouttxt leading-[1.25em] md:leading-[1.08em]'}>I am a fullstack developer based in San Francisco, CA. I love interactive and dynamic design. Flow and rythm are both something I focus on and enjoy.</h1>
            </div>
        </section>
    )
}
